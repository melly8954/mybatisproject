...
//    }
    ...
    @GetMapping("/categoryList/category_list")    // 브라우저의 URL 주소
...
//            model.addAttribute("pageHtml", sPages);
        ...
        return "categoryList/category_list";  // resources/templates 폴더안의 화면파일
    }

    @GetMapping("/categoryList/category_listView")    // 브라우저의 URL 주소
    public String categoryListView(Model model, @RequestParam Long id) {
        ...
        return "categoryList/category_listView";  // resources/templates 폴더안의 화면파일
    }

    @PostMapping("/categoryList/category_list_update")
    ...
    @GetMapping("/categoryList/category_list_delete")
    ...
    @PostMapping("/categoryList/category_list_insert")
    public String categoryListInsert(@ModelAttribute CategoryDto dto, Model model) {
        ...
        return "categoryList/category_list?page=1&name=";  // 브라우저 주소를 redirect 한다.
    }
}
